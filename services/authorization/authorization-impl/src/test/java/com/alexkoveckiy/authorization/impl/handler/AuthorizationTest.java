...
public class AuthorizationTest {
    ...
    @Test
    public void test() throws MalformedClaimException, InvalidTokenException {
        registerProcessTest();
    ...
    public void smsConfirmProcessTest() {
    ...
    public void loginProcessTest() throws InvalidTokenException, MalformedClaimException {
